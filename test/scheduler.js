...
describe('Scheduler', function () {
  describe('Init', function () {
    it('Initializes Successfully', function (done) {
      const stub = sinon.stub(queueFactory, 'Init').callsFake(function (cb) {
  ...
  describe('Add Jobs', function () {
    before(function () {
      const time = new Date('2021-12-27 18:00:00');
      tk.freeze(time);
    });
    ...
    describe('AddRepeatingJob', function () {
      ...
      it('Add Successfully', function (done) {
        ...
        const qfExists = sinon.stub(queueFactory, 'Exists').callsFake(function (queue) {
  ...
  describe('Delete Job', function () {
    describe('DeleteRepeatingJob', function () {
      ...
      it('Deletes Successfully', function (done) {
        const stub = sinon.stub(queueFactory, 'GetQueue').callsFake(function () {
          return {
